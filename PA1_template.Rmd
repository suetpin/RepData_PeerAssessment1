...
```
Mean of the total number of steps taken per day: **`r as.integer(meanStepsOfDay)`**   
Median of the total number of steps taken per day: **`r as.integer(medianStepsOfDay)`**  
...
The 5-minute interval that have maximum number of steps on average across all the days is: **`r intervalWithMaxStep`**  
...
Missing Values in dataset: **`r missingValues`**  
...
Mean for the total number of steps taken per day: **`r as.integer(newMeanStepsOfDay)`**  
Median for the total number of steps taken per day: **`r as.integer(newMedianStepsOfDay)`**  
